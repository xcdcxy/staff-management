        ...
        <div class="hy_list">
            ...
            <table cellpadding="0" cellspacing="0" class="list_hy">
                ...
                <tr>
                    ...
                    <td>${staff.status}</td>
                    <td>
                        <a href="<%=path %>/staff/toEdit.do?id=${staff.id}" class="btn">编辑</a>
                        <a href="<%=path %>/staff/remove.do?id=${staff.id}" class="btn">删除</a>
                        <a href="<%=path %>/staff/detail.do?id=${staff.id}" class="btn">查看</a>
                    </td>
                </tr>
                </c:forEach>
            </table>
            ...
            <div class="r_foot">
                <div class="r_foot_m">
                    <a href="<%=path %>/staff/toAdd.do" class="btn">添加</a>
                </div>
            </div>
            <!--右边底部-->
        </div>
